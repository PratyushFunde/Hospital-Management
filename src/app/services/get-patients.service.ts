...
export class GetPatientsService {
  ...
  constructor() {const result:any = this.convertToObjectsArray(this.data);
    console.log(result); }

   convertToObjectsArray(data: any[]) {
    return data.map((item) => ({
      ...
      diagnosisHistory: item.diagnosis_history.map((history: { month: any; year: any; blood_pressure: any; heart_rate: any; respiratory_rate: any; temperature: any; }) => ({
        month: history.month,
        year: history.year,
      ...
      diagnosticList: item.diagnostic_list.map((diagnostic: { name: any; description: any; status: any; }) => ({
